<?php
	...
	function insertEmployee($id,$name,$dob,$salary,$address,$gender,$email,$mobile,$status)
	{
		$query="INSERT INTO emp VALUES('$id','$name','$dob','$salary','$address','$gender','$email','$mobile','$status')";
		execute($query);
